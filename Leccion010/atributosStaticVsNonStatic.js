...
class Persona {
    ...
    constructor(nombre, apellido) {
        ...
        //no podemos acceder a las variables estaticas con el objeto this, se deben acceder con el nombre de la clase
        Persona.contadorObjetosPersona++;
        console.log(`Se incremententa contador: ${Persona.contadorObjetosPersona}`);
...
//las clases hijas tambien heredan los atribtos estaticos
