...
class Persona {
    ...
    //metodo static que no se puede modificar
    static get MAX_OBJ() {
        return 5;
    }
...
let persona3 = new Persona('Pablo', 'Vittar');
console.log(persona3.toString());
let persona4 = new Persona('Nicolas', 'Niño');
console.log(persona4.toString());
let persona5 = new Persona('Valentina', 'Arango');
